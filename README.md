...
License -> https://github.com/FakeEnemy01/ProMusicBot/blob/master/LICENSE

```

## Deploy to Heroku

[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/FakeEnemy01/ProMusicBot)

NOTE: Make sure you have started a VoiceChat in your Group before deploying.
### Deploy to VPS

```sh
git clone https://github.com/FakeEnemy01/ProMusicBot
cd ProMusicBot
...
4. `SESSION_STRING` : Generate From here [![GenerateStringName](https://img.shields.io/badge/repl.it-generateStringName-yellowgreen)](https://repl.it/@primeminister0/getStringName)
...
Connect Me On [Telegram](https://telegram.dog/FakeEnemy01)
